...
int main(int argc, const char **argv) 
{
  ...
  //                  and you can optionally import crushmap to osdmap (if you don't, defualt crushmap will be used) by
  //                  # osdmaptool --import-crush crushmap-file osdmap-file
  //keyring.mon-file: generated by ceph-authtool --create-keyring;)             --simon
  if (mkfs) {
