...
int main(int argc, const char **argv) 
{
  ...
  //
  //See func parse_argv()
  //--monmap argument is saved in g_conf->monmap
  //-k       argument is saved in g_conf->keyring
  //--osdmap is not parsed in parse_argv(), but it's parsed in code above and saved in osdmapfn;
  //
  //mon-id:           like a, b, ...
  //monmap-file:      generated by monmaptool, e.g.
  //                  # monmaptool --create --clobber --add a 10.10.0.10:6789 --add b 10.10.0.11:6789 --add c 10.10.0.12:6789 --print monmap-file
  //                  you can check the generated monmap by:
  //                  # monmaptool --print monmap-file
  //                  monmaptool: monmap file monmap-file
  //                  epoch 0
  //                  fsid 81a1d0aa-5937-4b59-a5ee-8583abfa41f5
  //                  last_changed 2016-02-26 01:00:54.365565
  //                  0: 10.10.0.10:6789/0 mon.a
  //                  1: 10.10.0.11:6789/0 mon.b
  //                  2: 10.10.0.12:6789/0 mon.c
  //
  //osdmap-file:      generated by osdmaptool, e.g.
  //                  # osdmaptool --create-from-conf osdmap-file -c ceph.conf
  //                  osdmaptool: osdmap file 'osdmap-file'
  //                  osdmaptool: writing epoch 1 to osdmap-file
  //                  #
  //                  # osdmaptool --print osdmap-file
  //                  osdmaptool: osdmap file 'osdmap-file'
  //                  epoch 1
  //                  fsid 00000000-0000-0000-0000-000000000000
  //                  created 2016-04-14 14:38:39.553186
  //                  modified 2016-04-14 14:38:39.553186
  //                  flags
  //
  //                  pool 0 'rbd' replicated size 1 min_size 1 crush_ruleset 0 object_hash rjenkins pg_num 576 pgp_num 576 last_change 0 flags hashpspool stripe_width 0
  //
  //                  max_osd 9
  //                  #
  //                  And you can optionally import crushmap to osdmap-file (if you don't, defualt crushmap will be used) by
  //                  # osdmaptool --import-crush crushmap-file osdmap-file
  //
  //keyring.mon-file: generated by ceph-authtool --create-keyring, and it's content looks like:
  //    [mon.]
